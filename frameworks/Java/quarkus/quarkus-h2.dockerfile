...
ENV JAVA_OPTIONS="-server -XX:-UseBiasedLocking -XX:+UseStringDeduplication -XX:+UseNUMA -XX:+UseParallelGC -Djava.lang.Integer.IntegerCache.high=10000 -Dhibernate.allow_update_outside_transaction=true -Djboss.threads.eqe.statistics=false"
